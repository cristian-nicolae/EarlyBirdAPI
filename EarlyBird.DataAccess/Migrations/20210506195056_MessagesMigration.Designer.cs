...
namespace EarlyBird.DataAccess.Migrations
{
    ...
    [Migration("20210506195056_MessagesMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EarlyBird.DataAccess.Entities.ConversationEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("EarlyBird.DataAccess.Entities.MessageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("EarlyBird.DataAccess.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Firstname = "Admin",
                            Lastname = "EarlyBird",
                            PasswordHash = "$2a$11$EWUQpZZJhtWWAYq1QrT.9eMdZy2IOKW1CB6pD6QjoMbgPzGphFniy",
                            Role = 1,
                            Salt = "$2a$11$9uXP2kT3wsQb0gwKSFpjHu",
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            Firstname = "Andrei",
                            Lastname = "Varga",
                            PasswordHash = "$2a$11$r.w7XmjPZo00SC6SE0tDKO0VN9n5epCxZX2hcsUzJkABueKkhXnWa",
                            Role = 2,
                            Salt = "$2a$11$RDycrh.3IgEozpA0MsGsBe",
                            Username = "worker"
                        },
                        new
                        {
                            ...
                            Lastname = "Popica",
                            PasswordHash = "$2a$11$lS1t...Bb5ATy7pK1NzqXeXKwPmmNhHGzZBr21qVHlIc/llWFDWHu",
                            Role = 3,
                            Salt = "$2a$11$qXa/wLktmruseCQx8bpIWu",
                            Username = "publisher"
                        },
                        new
                        {
                            ...
                            Lastname = "Socaci",
                            PasswordHash = "$2a$11$bL0SsK9impYFa2HlRqYVK.54oT8ErBCgh6mfSa0rPkAMLKsOrtE7q",
                            Role = 3,
                            Salt = "$2a$11$8.yHknAvDwfbSN0NOkVBEe",
                            Username = "publisher2"
                        },
                        new
                        {
                            ...
                            Firstname = "Flaviu",
                            Lastname = "Raita",
                            PasswordHash = "$2a$11$1QMloKfLvlvo2tcwWJllFuXMf9R440LuIs.yRT3PcG3ICzam1Ssa.",
                            Role = 2,
                            Salt = "$2a$11$rZcciXNErBkUFZUkryzpYe",
                            Username = "worker2"
                        });
                });
            ...
            modelBuilder.Entity("EarlyBird.DataAccess.Entities.ConversationEntity", b =>
                {
                    b.HasOne("EarlyBird.DataAccess.Entities.UserEntity", "First")
                        .WithMany()
                        .HasForeignKey("FirstId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EarlyBird.DataAccess.Entities.UserEntity", "Second")
                        .WithMany()
            ...
            modelBuilder.Entity("EarlyBird.DataAccess.Entities.MessageEntity", b =>
                {
                    b.HasOne("EarlyBird.DataAccess.Entities.ConversationEntity", "ConversationEntity")
                        .WithMany()
